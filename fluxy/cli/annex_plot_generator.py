...
def produce_plots(regions, output_path, inventory_years):
    ...
    for species in monthly_species:
        ...
        fig, res_dict = func.plot_country_flux(
            ds_all_flux_scaled,
            species,
            regions,
            s_data,
    ...
    for species in combined_species:
        ...
        ### Read and scale fluxes
        ds_all_flux_scaled = func.read_flux_total_fgases(
            data_dir,
            species,
            models,
            s_data,
